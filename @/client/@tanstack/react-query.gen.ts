...
import { type Options, deleteInvoiceByInvoiceId, getInvoiceByInvoiceId, putInvoiceByInvoiceId, getInvoiceList, postInvoice, postInvoiceLineByInvoiceId, deleteInvoiceLineByInvoiceIdByLineNumber, putInvoiceLineByInvoiceIdByLineNumber } from '../sdk.gen';
import { type UseMutationOptions, type DefaultError, queryOptions } from '@tanstack/react-query';
import type { DeleteInvoiceByInvoiceIdData, GetInvoiceByInvoiceIdData, PutInvoiceByInvoiceIdData, GetInvoiceListData, PostInvoiceData, PostInvoiceResponse, PostInvoiceLineByInvoiceIdData, DeleteInvoiceLineByInvoiceIdByLineNumberData, PutInvoiceLineByInvoiceIdByLineNumberData } from '../types.gen';
...
export const postInvoiceLineByInvoiceIdMutation = (options?: Partial<Options<PostInvoiceLineByInvoiceIdData>>) => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<PostInvoiceLineByInvoiceIdData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postInvoiceLineByInvoiceId({
                ...options,
                ...localOptions,
