...
export const getInvoiceLineByInvoiceIdByLineNumber = <ThrowOnError extends boolean = false>(options: Options<GetInvoiceLineByInvoiceIdByLineNumberData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetInvoiceLineByInvoiceIdByLineNumberResponse, unknown, ThrowOnError>({
        url: '/Invoice/Line/{invoiceId}/{lineNumber}',
        ...options
    });
};
...
export const postInvoiceLineByInvoiceId = <ThrowOnError extends boolean = false>(options: Options<PostInvoiceLineByInvoiceIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostInvoiceLineByInvoiceIdResponse, unknown, ThrowOnError>({
